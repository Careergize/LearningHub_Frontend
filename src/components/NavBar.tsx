  ...
  return (
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl z-50 glass rounded-full shadow-lg px-6 md:px-8 py-3.5 flex justify-between items-center transition-all">
      ...
      <div className="hidden md:flex gap-8 items-center">
        <a
          href="#courses"
          className="font-sans text-sm font-medium text-brand-dark/70 hover:text-brand-primary transition-colors"
        >
          Courses
        </a>
        ...
        <a
          href="#mentor"
          className="font-sans text-sm font-medium text-brand-primary font-semibold border-b-2 border-brand-primary pb-1"
        >
          AI Mentor
        </a>
      ...
      <div className="flex gap-4 items-center">
        ...
        <button
          onClick={goToLogin}
          className="hidden lg:block font-sans text-sm font-semibold text-brand-dark/70 hover:text-brand-primary transition-colors"
        >
          Student Login
        </button>
      ...
      {isOpen && (
        ...
        >
          <a
            ...
            href="#courses"
            className="font-sans text-base font-semibold text-brand-dark/85 py-1"
          >
            Courses
          </a>
          ...
          <a
            onClick={() => setIsOpen(false)}
            href="#mentor"
            className="font-sans text-base font-semibold text-brand-primary py-1"
          >
            AI Mentor
          </a>
          ...
          <button
            onClick={goToLogin}
            className="text-left font-sans text-sm font-semibold text-brand-dark/70 py-2"
          >
            Student Login
          </button>
        </motion.div>
